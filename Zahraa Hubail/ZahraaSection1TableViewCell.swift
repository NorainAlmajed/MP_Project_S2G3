...
// Protocol declared once, outside the class
protocol ZahraSection1TableViewCellDelegate: AnyObject {
    func section1DidTapUploadImage(_ cell: ZahraaSection1TableViewCell)
}

class ZahraaSection1TableViewCell: UITableViewCell {
...
//    // ✅ 2) Add delegate variable
     weak var delegate: ZahraSection1TableViewCellDelegate?
